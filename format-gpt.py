...
typst_text = re_upright_op.sub(r'op("\1")(', typst_text)

typst_text = typst_text.replace(r"dot.op", r"dot")
typst_text = typst_text.replace(r"integral_", r"int_")
typst_text = typst_text.replace(r"integral.cont", r"oint")
...
typst_text = typst_text.replace(r"thin bf", "bf")
...
typst_text = typst_text.replace(r"⟨ ", "angle.l ")
typst_text = typst_text.replace(r"⟨", "angle.l ")
typst_text = typst_text.replace(r" ⟩", " angle.r")
typst_text = typst_text.replace(r"⟩", "angle.r")
