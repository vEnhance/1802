...
On the following pages is a draft of the solutions to the questions
for those of you who are trying the questions in advance.
Later on this will be cleaned up and edited
(probably based on questions that people ask during the actual review session).
The final version should be posted Monday evening
in Section 29 of my LAMV book at #url("https://web.evanchen.cc/1802.html").
]
...
== Solution to the level curve (P2)
...
== Solution to the two-variable function (P4)
...
It's essentially the figure in LAMV in the experiment (TODO: hyperlink this).
...
== Solution to the constrained optimization (P5)
