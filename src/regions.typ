...
#figure(
  table(
    ...
    align: center + horizon,
    table.header([Region], [Dim.], [Boundary], [Limit cases]),
    [All of $RR^2$], [2D], [No boundary], [$x -> pm oo$ or $y -> pm oo$],
    [$x,y > 0$], [2D], [No boundary], [$x -> 0^+$ or $y -> 0^+$ \ or $x -> +oo$ or $y -> +oo$],
    [$x,y >= 0$], [2D], [$x=0$ or $y=0$], [$x -> +oo$ or $y -> +oo$],
    [$-1 < x < 1 \ -1 < y < 1$], [2D], [No boundary], [$x,y -> pm 1$],
...
#figure(
  table(
    ...
    align: center + horizon,
    table.header([Region], [Dim.], [Boundary], [Limit cases]),
    [All of $RR^3$], [3D], [No boundary], [Any var to $pm oo$],
    [$x,y,z > 0$], [3D], [No boundary], [Any var to $0$ or $oo$],
    [$x,y,z >= 0$], [3D], [$x=0$ or $y=0$ or $z=0$], [Any var to $oo$],
    ...
    [$x + y + z = 1$], [2D], [No boundary], [Any var to $pm oo$],
    [$x + y + z = 1 \ x, y, z > 0$], [2D], [No boundary], [Any var to $0^+$],
    [$x + y + z = 1 \ x, y, z >= 0$], [2D], [$x=0$ or $y=0$ or $z=0$], [No limit cases],
  ),
  kind: table,
