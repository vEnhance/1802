...
== Problems from the Putnam Exam

The #link("https://w.wiki/GdjS")[Putnam exam]
is a difficult undergraduate mathematics exam held annually in December.
The majority of the problems are well outside of the syllabus of 18.02,
so I wouldn't recommend going on and trying even the "easy" problems
from a random given year.

Nonetheless, here are a few specifically chosen problems
for which the solution is within the 18.02 syllabus,
so you could potentially get something out of thinking about the problems
and reading the solutions (even if you don't solve any of them).

#exer[Putnam 2006 A1][
  Compute the volume of the set of points $(x,y,z) in RR^3$ satisfying
...
#exerstar[Putnam 2025 B2][
  Let $f : [0,1] -> [0,oo)$ be strictly increasing and continuous.
  Let $R$ be the region bounded by $x=0$, $x=1$, $y=0$, and $y=f(x)$.
  Let $x_1$ be the $x$-coordinate of the center of mass of $R$.
  Let $x_2$ be the $x$-coordinate of the center of mass
  of the solid generated by rotating $R$ about the $x$-axis.
  Show that $x_1 < x_2$.
]
