...
#epigraph(attribution: [_Infinite Jest_, by David Foster Wallace])[
...
#epigraph(attribution: [Lydia's opening line in
...
#epigraph(attribution: [Koro-sensei in _Assassination Classroom_])[
...
#epigraph(attribution: [Author notes for
