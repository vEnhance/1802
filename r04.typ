...
In what follows, $T : RR^2 -> RR^2$.
In R03 I gave you two questions to motivate the definition of a matrix:
...
Now, if I wanted to make your life hard I could have equally well used the
following variation of the first question:
...
That's why we say $vec(3,4)$ and $vec(100,100)$ are a _basis_ of $RR^2$.
Every point like $vec(13, 37)$ can be written as
$ vec(13,37) = c_1 vec(3,4) + c_2 vec(100,100) $
for some $c_1$ and $c_2$, and you can solve Q3 for any vector $bf(v)$ in place of $vec(13,37)$.
(I think Poonen calls this "changing coordinates": see Poonen 4.6).
